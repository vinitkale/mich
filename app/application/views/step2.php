<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	...
	<div class="page-container">
		...
		<div class="page-content setup-page-content">
			...
			<img src="../admin-assets/pages/img/tut2.jpg" alt="tutorial2" width="600px"/>
			<p><strong>Step 2: </strong>Check the box. Then click "Next".</p>
			<div class="margin-top-10">
			    <a href="<?php echo base_url('home/step1'); ?>" class="btn default"> Back </a>
			    <a href="<?php echo base_url('home/step3'); ?>" class="btn green"> Next </a>
			</div>
                    </div>
                    <!-- SETUP CONTAINER -->
                    <!-- END CONTENT BODY -->
