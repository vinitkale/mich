 ...
 * ********************************************************************* */
//define('AWS_ACCESS_KEY_ID', $data['aws_access_key_id']);
//define('AWS_SECRET_ACCESS_KEY', $data['aws_secret_access_key']);
 ...
 * ********************************************************************* */
//define('APPLICATION_NAME', 'APPAMZ');
 ...
 * marketplace ID.
 * ********************************************************************* */
//define('MERCHANT_ID', $data['merchant_id']);
//define('MARKETPLACE_ID', $data['marketplace_id']);
 ...
 * ********************************************************************* */
//    set_include_path(get_include_path() . PATH_SEPARATOR . './amazon/src');
set_include_path(APPPATH . 'libraries/amazon/order');

//echo APPPATH . 'libraries/amazon/src';
/* * ********************************************************************** 
 * OPTIONAL ON SOME INSTALLATIONS  
 * 
